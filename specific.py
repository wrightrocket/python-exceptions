'''
Example of how specific exception handling may be done.
'''
...
try:
    ...
    # Display an specific error message or handle it
    print("Bad input, please only input one number")
except ZeroDivisionError:
    # Display an specific error message or handle it
    print("Bad input, dividing by zero results in infinity")
else:
